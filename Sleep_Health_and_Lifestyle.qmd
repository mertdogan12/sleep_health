...
Es zeigt sich kein eindeutiger Zusammenhang zwischen körperlicher Aktivität und Schlafqualität. Es lässt sich jedoch leichten Anstiegt erkennen. Zudem sind zwei größere Ausreißer sichtbar. Einen bei einer guten Schlafqualität trotz körperlicher Aktivität und einer bei schlechter Schlafqualität trotz hoher körperlicher Aktivität. Diese haben jedoch ein hohes und niedriges Stresslevel. Die Schlafqualität ist in diesen Fällen also von Stresslevel beeinflusst.
...
Man kann zu beiden Graphen sagen, dass sie eine große Spannweite haben. Somit gibt es keine klare Trennung zwischen den beiden Gruppen.

Bei Personen ohne Schlafstörung liegt der Median der täglichen körperlichen Aktivität höher als bei Personen mit Schlafstörungen, was darauf hindeutet, dass erstere mehr körperliche Aktivität ausüben. Gleichzeitig ist das untere Quartil bei Personen mit Schlafstörungen höher als bei Personen ohne.

Das bedeutet, dass die am wenigsten aktiven Personen dennoch ein hohe körperliche Aktivität aufweisen als weniger aktive Personen ohne Schlafstörung.
...
Auch die Schtrittzahl zeigt keinen eindeutigen Zusammenhang zur Schlafqualität. Der stärkere Auslößer scheint auch hier das Stresslevel zu sein.
...
Ähnlich wie im Diagramm *Schlafstörungen und körperliche Aktivität* weisen Personen ohne Schlafstörung eine größere Spannweite sowie einen höheren Median auf als Personen mit Schlafstörungen. Personen mit Schlafstörungen zeigen hingegen eine geringere Spannweite. Der Median liegt zwar niedriger, jedoch ist das untere Quartil höher als bei Personen ohne Schlafstörung.

Insgesamt ähnelt sich dieses Diagramm stark dem Diagramm *Schlafstörungen und körperliche Aktivität*. Lediglich das obere Quartil der Personen mit Schlafstörung fällt im Vergleich etwas niedriger aus. Trotz dieser Unterschiede lässt sich keine eindeutigen Zusammenhang zwischen der täglischen Strittzahl und dem Auftreten von Schlafstörungen erkennen.

Aus den Diagrammen ergibt sich also:

**Körperliche Aktivität scheint die Schlafqualität nicht zu beeinflussen**
