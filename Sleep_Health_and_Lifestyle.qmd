...
Da für uns es nicht relevant ist, um welche Schlafstörung es sich genau handelt, geben wir nur an, ob eine Schlafstörung vorhanden ist.
...
Um die Weiterverarbeitung zu vereinfachen, wandeln wir die *BMI.Category* zu einem Faktor um. Dabei werden wir auch die Reihenfolge der Kategorien beachten.
...
**Ein hohes Level an Stress wirkt sich negativ auf die Schlafqualität aus.**
...
Somit lässt sich die These nur zum Teil bestätigen. Viel Stress hat einen großen Einfluss auf die Schlafqualität. Dagegen hat die körperliche Aktivität nur einen leichten Einfluss auf die Schlafqualität.
...
Alles in allem kann man also sagen, dass der zweite Graph eindeutigere Ergebnisse liefert. Somit wird die am Anfang aufgestellte These bestätigt: Schlafqualität scheint im Alter abzunehmen. Jedoch kann man nicht sagen, dass dies ein eindeutiges Ergebnis ist, da sich die Graphen teilweise widersprechen.
