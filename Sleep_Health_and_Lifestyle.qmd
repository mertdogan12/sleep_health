...
Die BMI Kategorie Untergewicht gibt es nicht. Somit gehen wir davon aus, dass *Normal* die Kategorie Untergewicht ist.
...
Die Daten weise insgesamt eine hohe Spannweite auf. Es ist jedoch eine deutliche Häufung von Personen mit Schlafstörungen im Bereich geringer täglicher körperlicher Aktivität zu erkennen.

Dies korrespondiert mit dem vorherigen Darstellung und stützt die Annahme, dass mehr körperliche Aktivität die Schlafqualität positiv beeinflusst.

Um den Zusammenhand zwichen körperlicher Aktivität und der Schlaqualität zu untersuchen, schhauen wir uns noch die tägliche Schrittzahl an. Die Schrittzahl dient hierbei als weiterer Indikator für die körperliche Aktivität.
...
Nun testen wir unser Modell mit dem fertigen Test Datensatz.
...
Durch das tunen der Parameter *mtry* und *min_n* konnten wir die Performance noch verbessern. Somit haben wir am Ende ein gut performendes Modell mit dem man weiter arbeiten kann.

Naturlich ist der Datensatz noch klein, somit müsste man das Modell auch mit mehr Daten testen um ein genaueres Ergebnis zu bekommen. Auch die Schlussfolgerung der Explorativen Datenanalyse würde durch mehr Daten und das einbeziehen von mehr Variablen ein eindeutigeres Ergebniss liefern.
